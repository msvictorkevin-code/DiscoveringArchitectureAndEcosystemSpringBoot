...
INSERT INTO usuarios (username, password, enabled, nombre, apellido, email) VALUES ('andres','$2a$10$VaxtnXXtgKYHhq9eZtiD.uEFKmDAV9DoLoZnHU4szGebycLmERtwW',1, 'Andres', 'Guzman','profesor@bolsadeideas.com');
INSERT INTO usuarios (username, password, enabled, nombre, apellido, email) VALUES ('admin','$2a$10$TVpCkF5orFL659RYUtHMHOEFytPiUAT7dEU2YCCp5VxPKBytzVjre',1, 'John', 'Doe','jhon.doe@bolsadeideas.com');
